package com.example.abhishree.favplaces;
...
public class MainActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SharedPreferences sharedPreferences= this.getSharedPreferences("package com.example.abhishree.favplaces", Context.MODE_PRIVATE);
